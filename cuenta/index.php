...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container">
            <div class="columns">
                <div class="column">
                    <h1 class="title is-1">Datos del usuario</h1>
                </div><!-- /.column -->
            </div><!-- /.columns -->
        </div><!-- /.container -->
    </div><!-- /.content-header -->
                            ...
                            <div class="columns">
                                ...
                                <div class="column">
                                    ...
                                    <div class="field">
                                        ...
                                        <input type="text" class="input" name="nombres" value="<?php echo $nombres; ?>" disabled />
                                    </div>
                                    <div class="field">
                                    ...
                                    <div class="field">
                                        ...
                                        <input type="text" class="input" name="email" value="<?php echo $rol; ?>" disabled />
                                    </div>
                                    <hr>
                                    ...
                                    <center>
                                        <div class="btn-group">
                                            ...
                                            <a class="button is-info" href="update.php?id=<?php echo $id_usuario; ?>" class="btn btn-success"><i class="fa fa-pen"></i>Editar</a>


                                            <a class="button is-danger" href="delete.php?id=<?php echo $id_usuario; ?>" class="btn btn-danger"><i class="fa fa-trash"></i>Eliminar Cuenta</a>
                                        </div>
                                    </center>
